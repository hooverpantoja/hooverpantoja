...
<body style="display: flex; margin: 0;">
  <main class="main-content">
    ...
    <section id="biomecanica">
      <h2>Biomecanica</h2>
      <ul>
        <li><strong><a href="semana2/">Semana 3 (Jueves Sept 26, 09:00-12:00):</a></strong> Cinemática - posición, trayectoria, velocidad, aceleración, caída libre, saltabilidad, proyección de proyectiles.</li>
