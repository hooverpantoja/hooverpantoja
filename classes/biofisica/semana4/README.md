    ...
    <section id="leyes">
        ...
        <div class="videos-dos" style="display: flex; gap:2em; justify-content:center; margin:2em 0; flex-wrap:wrap;">
          <div class="video-frame" style="background:#f1f5fa; border-radius:10px; box-shadow:0 2px 8px #e0e7ef; padding:1em; width:350px; text-align:center;">
            ...
            <div style="color:#2563eb; font-size:0.95em;">Video 1. Aplicación de la tercera ley.</div>
          </div>
          <div class="video-frame" style="background:#f1f5fa; border-radius:10px; box-shadow:0 2px 8px #e0e7ef; padding:1em; width:350px; text-align:center;">
            ...
            <div style="color:#2563eb; font-size:0.95em;">Video 2. Fuerzas y biomecánica marina.</div>
          </div>
        </div>
          ...
          <li>Movimiento uniforme rectilineo</li>
            ...
            <figure style="text-align:center; margin:2em 0;">
              <a href="res/mov_unif.png" target="_blank">
                <img src="res/mov_unif.png" alt="Aceleración" style="max-width:150px; width:100%; border-radius:10px; box-shadow:0 2px 8px #e0e7ef;">
              </a>
