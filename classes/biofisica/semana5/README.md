...
<body style="display: flex; margin: 0; min-height: 100vh;">
  ...
  <main style="flex: 1; padding: 2.5em 3em; background: #fff; min-height: 100vh; margin-left: 240px;">
    ...
    <h2 class="subtitulo" id="leyes-de-newton">Ondas Mecánicas</h2>
        ...
        <p class="parrafo">El sonido consiste en ondas armónicas, es decir que se pueden representar a partir de funciones sinusoidales, de manera en que se puede determinar el grado de perturbación y a partir de el número de onda <strong>k</strong> y la frecuencia de la perturbación <strong>f</strong>. Así, la perturbación de una onda armónica sinusoidal se expresa como <strong>y(x,t) = Asen(kx - 2πf)</strong>.  </p>
