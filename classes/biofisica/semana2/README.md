    ...
    <div class="container">
      ...
      <section id="tamano-forma">
        ...
        <ul>
          ...
          <li><strong>Límites de Tamaño:</strong> Existe un límite inferior (tamaño de moléculas complejas, virus, micoplasmas, que requieren interacciones de muchas moléculas para la autonomía) y un límite superior. En mamíferos terrestres actuales, elefantes y rinocerontes representan masas extremas sin necesidad de soporte de flotación. Las secuoyas gigantes pueden superar ampliamente la masa de los animales terrestres más grandes, aunque gran parte de su volumen corresponde a tejido estructural. La diferencia de masa entre un micoplasma y un gran mamífero terrestre abarca alrededor de 20 órdenes de magnitud.</li>
        </ul>
        <div style="display: flex; justify-content: center; align-items: center; gap: 2em; margin: 2em 0;">
          <div class="video-frame">
