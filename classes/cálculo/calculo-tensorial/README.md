...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .coming-soon strong { display: block; margin-bottom: 0.5em; font-size: 1.1em; }
    .topics {
      text-align: left;
      list-style: none;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <div class="coming-soon">
      ...
      Temas que se cubrirán en este módulo:
      <ul class="topics">
        <li>Notación de índices y convención de Einstein</li>
        <li>Tensores covariantes, contravariantes y mixtos</li>
        <li>Tensor métrico y conexión de Christoffel</li>
