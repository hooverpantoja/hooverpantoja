...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .badge { color: #2563eb; font-size: 0.95em; margin-bottom: 2em; display: block; }
...
<body>
  <div class="container">
    ...
    <ul>
      <li><a class="tema" href="edo-primer-orden.html">EDO de Primer Orden</a></li>
      <li><a class="tema" href="edo-segundo-orden.html">EDO de Segundo Orden</a></li>
      <li><a class="tema" href="series-potencias.html">Series de Potencias</a></li>
      <li><a class="tema" href="edp-separacion-variables.html">EDP y Separación de Variables</a></li>
      <li><a class="tema" href="funcion-green.html">Función de Green</a></li>
    </ul>
  </div>
